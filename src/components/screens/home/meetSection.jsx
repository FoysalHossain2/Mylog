    ...
    <section className=" text-white py-16 px-4 md:px-12 lg:px-24">
      <div className="relative">
        ...
        <div className="container mx-auto">
          ...
          <div className="w-full h-full rounded-[96px] p-20 overflow-hidden bg-[#3276DE] z-30">
            <div className="relative z-10 flex flex-col xl:flex-row items-center gap-8">
              <div className="md:w-1/2">
                <h2 className="text-[64px] md:text-4xl font-normal leading-[100%]">
                  Let's Meet Tomorrow
                </h2>
              ...
              <div className="md:w-1/2 w-full  flex flex-col xl:flex-row gap-6">
                {executives.map((exec, index) => (
                  ...
                  >
                    ...
                    />
                    <h4 className="text-[32px] font-semibold mt-4">{exec.name}</h4>
                    <p className="text-sm text-gray-300">{exec.role}</p>
                    <button className="mt-12 group relative py-4 px-8 w-[294px] text-lg font-medium bg-[#F0F7FE] hover:bg-transparent hover:text-[#F0F7FE] text-[#030E21] border hover:border-[#F0F7FE] rounded-full flex items-center justify-between transition ease-in-out duration-300 uppercase">
                     Request a Meeting
